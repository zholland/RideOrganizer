...
class TravellerMatchingTest < Test::Unit::TestCase
  def setup
    ...
    trip.add_driver(DriverContainer.new(2, "Bronislava Matveev", "bronislavamatveev@email.com", "1901 Harvey Ave, Kelowna, BC", 2))
    trip.add_driver(DriverContainer.new(3, "Feliks Konstantinov", "felikskonstantinov@email.com", "1000 K. L. O. Rd, Kelowna, BC", 3))
    trip.add_passenger(PassengerContainer.new(4, "Klara Utkin", "klarautkin@email.com", "4346 Gordon Dr, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(5, "Rolan Pavlov", "rolanpavlov@email.com", "705 Kitch Rd, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(6, "Geert Alvarsson", "geertalvarsson@email.com", "820 Guy St, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(7, "Anina Madsen", "aninamadsen@email.com", "715 Rutland Road North, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(8, "Gennadiz Hivkov", "gennadizhivkov@email.com", "1938 Kane Rd, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(9, "Mitrofan Pavlov", "mitrofanpavlov@email.com", "5533 Airport Way, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(10, "Anna Sokolov", "annasokolov@email.com", "1959 K. L. O. Road, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(11, "Milena Volkov", "milenavolkov@email.com", "190 Aurora Crescent, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(12, "Manya Yakovlev", "manyayakovlev@email.com", "1505 Gordon Dr, Kelowna, BC"))
    trip.add_passenger(PassengerContainer.new(13, "Feodora Petrov", "feodorapetrov@email.com", "1555 Burtch Road, Kelowna, BC"))
